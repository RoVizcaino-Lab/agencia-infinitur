  ...
  return (
    <div data-testid="gallery-page" className="pt-32 pb-24 bg-bone min-h-screen">
      <div className="max-w-7xl mx-auto px-6 lg:px-8">
        <div className="text-xs uppercase tracking-[0.25em] text-terracotta mb-4">Galería</div>
        ...
        <div className="columns-1 sm:columns-2 lg:columns-3 gap-5 [column-fill:_balance]">
          {photos.map((p) => (
            <div key={p.id} className="break-inside-avoid mb-5 rounded-2xl overflow-hidden bg-white border border-[#E5E0D8] group">
              <img src={p.url} alt={p.caption} loading="lazy" className="w-full h-auto block group-hover:scale-105 transition-transform duration-700" />
